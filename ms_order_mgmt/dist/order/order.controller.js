...
let OrderController = class OrderController {
    ...
    async updateProduct(orderStatus) {
        try {
    ...
    async findOrderByCustomerId(idCustomer) {
...
__decorate([
    (0, common_1.Put)('updateorderstatus'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], OrderController.prototype, "updateProduct", null);
__decorate([
    (0, common_1.Get)('findorderbycustomerid/:idcustomer'),
    __param(0, (0, common_1.Param)('idcustomer')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], OrderController.prototype, "findOrderByCustomerId", null);
